...
def run_efc_perfect(sysi, 
    ...
    embedded_controller.do_decomposition(reg_cond)
    ...
    for i in range(iterations):
        ...
        if est_fun is None:
            ...
            electric_field = est_fun(sysi, embedded_controller, **est_params)
        efield_ri = xp.zeros(2*Nmask)

        efield_ri[::2] = electric_field[control_mask].real
        efield_ri[1::2] = electric_field[control_mask].imag
        
        modal_coefficients = embedded_controller.do_EFC_with_decomp(efield_ri)
