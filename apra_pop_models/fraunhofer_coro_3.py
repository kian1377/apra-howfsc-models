...
class CORO():
    ...
    def __init__(self, 
                 ...
                 dm1_ref=np.zeros((128, 128)),
                 dm2_ref=np.zeros((128, 128)),
    ...
    def init_dms(self):
        ...
        self.DM1 = dm.DeformableMirror(Nact=self.Nact, act_spacing=act_spacing, pupil_diam=50*u.mm, 
                                       inf_fun=inf, inf_sampling=sampling, 
                                       name='DM1',)
        self.DM2 = dm.DeformableMirror(Nact=self.Nact, act_spacing=act_spacing, pupil_diam=50*u.mm, 
                                       inf_fun=inf, inf_sampling=sampling, 
                                       name='DM2',)
